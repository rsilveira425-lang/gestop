...
import { db, auth } from './conexoes (services)/firebase'
import { AuthProvider, useAuth } from './memoria-global (contexts)/AuthContext'
import { getTurnos } from './ajustes (config)/turnos'
import Login from './telas (pages)/login-e-cadastro (auth)/Login'
import Cadastro from './telas (pages)/login-e-cadastro (auth)/Cadastro'
import Recuperar from './telas (pages)/login-e-cadastro (auth)/Recuperar'
import Onboarding from './telas (pages)/primeiros-passos (onboarding)/Onboarding'
import Dashboard from './telas (pages)/painel-colaborador (dashboard)/Dashboard'
import EntrarRestaurante from './telas (pages)/login-e-cadastro (auth)/EntrarRestaurante'
import Landing from './telas (pages)/pagina-de-vendas (landing)/Landing'
import Privacidade from './telas (pages)/juridico (legal)/Privacidade'
import Paywall from './telas (pages)/pagamento (billing)/Paywall'
import { diasRestantesTrial } from './ajustes (config)/billing'
