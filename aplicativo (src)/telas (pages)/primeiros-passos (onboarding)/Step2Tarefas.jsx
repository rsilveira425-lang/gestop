...
const styles = {
  ...
  tabOn: { border:'2px solid var(--gs-action)', background:'#eff6ff', color:'var(--gs-action)', fontWeight:600 },
  ...
  addBtn: { padding:'11px 18px', background:'var(--gs-action)', color:'#fff', border:'none', borderRadius:'8px', fontWeight:700, cursor:'pointer', fontSize:'18px' },
