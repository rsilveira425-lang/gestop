...
import { PRECO_MENSAL, PRECO_MENSAL_VALOR, DIAS_TRIAL, LINK_ASSINATURA, EMAIL_CONTATO, linkAssinaturaPara } from '../../ajustes (config)/billing'
...
const s = {
  ...
  card: { backgroundColor: 'white', borderRadius: '16px', padding: '36px 28px', maxWidth: '420px', width: '100%', textAlign: 'center', boxShadow: 'var(--gs-shadow-sm)' },
  ...
  btnAssinar: { display: 'block', padding: '15px', borderRadius: '12px', background: 'var(--gs-action)', color: 'white', fontSize: '16px', fontWeight: 700, textDecoration: 'none', boxShadow: 'var(--gs-shadow-action)' },
